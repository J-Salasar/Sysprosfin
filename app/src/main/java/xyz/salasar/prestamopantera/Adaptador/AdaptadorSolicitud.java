...
public class AdaptadorSolicitud extends BaseAdapter {
    private ArrayList<String> nombre,apellido,telefono,correo,usuario,id;
    private Context context;
    private static LayoutInflater inflater=null;
    private TextView txt_nombre, txt_telefono, txt_correo;
    public AdaptadorSolicitud( Context context, ArrayList<String> nombre, ArrayList<String> apellido, ArrayList<String> telefono, ArrayList<String> correo, ArrayList<String> usuario, ArrayList<String> id){
        this.nombre=nombre;
