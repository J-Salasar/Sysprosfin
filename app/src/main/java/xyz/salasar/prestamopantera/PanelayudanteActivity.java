...
public class PanelayudanteActivity extends AppCompatActivity {
    ...
    private Button transferir, notificacion,recargar, pagarPrestamo, pagoPrestamo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panelayudante);
        ...
        cuenta=findViewById(R.id.cuenta5551);
        empresa=findViewById(R.id.empresa5551);
        credito=findViewById(R.id.credito5551);
        congelado=findViewById(R.id.congelado5551);
        deuda=findViewById(R.id.deuda5551);
        intereses=findViewById(R.id.intereses5551);
        tipo=findViewById(R.id.tipo5551);
        volver=findViewById(R.id.volver5551);
        transferir=findViewById(R.id.transferir5551);
        notificacion=findViewById(R.id.notificacion5551);
        listaHistorial=findViewById(R.id.historial5551);
        recargar=findViewById(R.id.recargar5551);
        mes=findViewById(R.id.mes5551);
        tiempo=findViewById(R.id.tiempo5551);
        buscar=findViewById(R.id.buscar5551);
        fecha=findViewById(R.id.fechaCreacion5551);
        pagarPrestamo=findViewById(R.id.pagoPrestamos5551);
        paneldatosSaldos=findViewById(R.id.paneldatosSaldos5551);
        panelCongelado=findViewById(R.id.panelCongelado5551);
        panelDeuda=findViewById(R.id.panelDeuda5551);
        panelprincipalOficial=findViewById(R.id.panelpropietarioOficial5551);
        notificacionNada=findViewById(R.id.notificacionNada5551);
        pagoPrestamo=findViewById(R.id.pagoPrestamo5551);
