...
public class PanelDirectorActivity extends AppCompatActivity {
    ...
    private Button transferir, notificacion,recargar,listaUsuarios, pagarPrestamo, pagoPrestamo,solicitudPrestamo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panel_director);
        ...
        cuenta=findViewById(R.id.cuenta51666);
        empresa=findViewById(R.id.empresa51666);
        credito=findViewById(R.id.credito51666);
        congelado=findViewById(R.id.congelado51666);
        deuda=findViewById(R.id.deuda51666);
        intereses=findViewById(R.id.intereses51666);
        tipo=findViewById(R.id.tipo51666);
        volver=findViewById(R.id.volver51666);
        transferir=findViewById(R.id.transferir51666);
        notificacion=findViewById(R.id.notificacion51666);
        listaHistorial=findViewById(R.id.historial51666);
        recargar=findViewById(R.id.recargar51666);
        listaUsuarios=findViewById(R.id.listaclientes51666);
        mes=findViewById(R.id.mes51666);
        tiempo=findViewById(R.id.tiempo51666);
        buscar=findViewById(R.id.buscar51666);
        fecha=findViewById(R.id.fechaCreacion51666);
        pagarPrestamo=findViewById(R.id.pagoPrestamos51666);
        paneldatosSaldos=findViewById(R.id.paneldatosSaldos51666);
        panelCongelado=findViewById(R.id.panelCongelado51666);
        panelDeuda=findViewById(R.id.panelDeuda51666);
        panelprincipalOficial=findViewById(R.id.panelpropietarioOficial51666);
        notificacionNada=findViewById(R.id.notificacionNada51666);
        pagoPrestamo=findViewById(R.id.pagoPrestamo51666);
        solicitudPrestamo=findViewById(R.id.solicitudPrestamo51666);
        panelprincipalOficial.removeView(notificacionNada);
        paneldatosSaldos.removeView(fecha);
        paneldatosSaldos.removeView(intereses);
        solicitudPrestamo.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                try {
                    ...
                    if(confirmacion.getString("mensaje").equals("aprobado")){
                        ...
                        if(Double.parseDouble(confirmacion.getString("deuda"))<0.01){
                            ...
                            paneldatosSaldos.addView(fecha);
                        ...
                        if(Double.parseDouble(confirmacion.getString("intereses"))<0.01){
                            ...
                            paneldatosSaldos.addView(intereses);
                        }
                    }
                    else{
